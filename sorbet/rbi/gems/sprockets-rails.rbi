...
class Sprockets::Rails::SourcemappingUrlProcessor
  def self.call(input); end
  def self.combine_sourcemap_logical_path(sourcefile:, sourcemap:); end
  def self.removed_sourcemap_comment(sourcemap_logical_path, filename:, env:); end
  def self.resolved_sourcemap_comment(sourcemap_logical_path, context:); end
  def self.sourcemap_asset_path(sourcemap_logical_path, context:); end
end
