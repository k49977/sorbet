...
class ActionView::Base
  ...
  def assets_environment=(arg0); end
  def assets_environment?; end
  ...
  def check_precompiled_asset=(arg0); end
  def check_precompiled_asset?; end
  def compiled_method_container; end
  def config; end
  def config=(arg0); end
  def debug_assets; end
  def debug_assets=(arg0); end
  def debug_assets?; end
  ...
  def precompiled_asset_checker=(arg0); end
  def precompiled_asset_checker?; end
  ...
  def resolve_assets_with=(arg0); end
  def resolve_assets_with?; end
  ...
  def unknown_asset_fallback=(arg0); end
  def unknown_asset_fallback?; end
  def view_paths(*args, &block); end
